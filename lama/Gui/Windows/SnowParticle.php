...
namespace ManiaLivePlugins\eXpansion\lama\Gui\Windows;

use ManiaLivePlugins\eXpansion\lama\Config;
...
class SnowParticle extends \ManiaLivePlugins\eXpansion\Gui\Widgets\PlainWidget
{
    ...
    protected function onConstruct()
    {
        ...
        $script = new \ManiaLivePlugins\eXpansion\Gui\Structures\Script("lama/Gui/Script");
