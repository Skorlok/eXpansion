...
/**
 * This will work on centralizing configurations in order to display
...
class ConfigManager
{
     ...
     */
    public static function getInstance($eXpCore = null)
    {
    ...
    /**
     * Saves current file scoped settings in a file
     *
     * @param $fileName
     */
