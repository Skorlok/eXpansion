...
class Permissions extends Window
{
    ...
    protected function onConstruct()
    {
        ...
        $this->button_ok->setContent('<frame posn="40 -101 1">' . \ManiaLivePlugins\eXpansion\Gui\Elements\Button::getXML(20, 5, __("OK"), null, null, null, null, null, $this->action_ok, null, null, null, null, null, null) . '</frame>');
