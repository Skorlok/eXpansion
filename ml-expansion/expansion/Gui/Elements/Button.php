...
class Button
{
    ...
    )
    {
        ...
        if (is_array($description)) {
            ...
            if ($isTextId) {
                $xml .='<label id="eXp_ButtonDescText_' . ($id ? $id : "Icon_" . $buttonId) . '" posn="7 3 5" sizen="' . $sizeXDesc . ' ' . $sizeYDesc . '" halign="left" valign="center2" style="TextStaticSmall" hidden="1" textcolor="000" textid="' . $description[0] . '" maxline="' . $maxLine . '"/>';
            } else {
    ...
    public static function getButtonXML(
        $sizeX = 32,
        $sizeY = 6,
        $text = null,
        $active = null,
