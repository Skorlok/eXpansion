...
class PlayerItem extends \ManiaLivePlugins\eXpansion\Gui\Control
{
    ...
    protected $bg;
    protected $label_index;
    protected $label_nickname;
    protected $label_time;
    protected $label_diff;
    protected $label_points;
    protected $frame;

    public function __construct(
        $indexNumber,
        \ManiaLivePlugins\eXpansion\Core\Structures\ExpPlayer $player,
        $login,
        $gamemode,
        $sizeX
    ) {
