...
class CustomUI_Deprecated extends \ManiaLivePlugins\eXpansion\Core\types\ExpPlugin
{
    ...
    {
        if ($var->getConfigInstance() instanceof \ManiaLivePlugins\eXpansion\CustomUI_Deprecated\Config) {
            $this->updateData();
        }
    }
