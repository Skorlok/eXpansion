...
class GBXChallMapFetcher extends GBXBaseFetcher
{
                    ...
                    if ($version >= 7) {
                        ...
                        switch ($this->type) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                $this->typeName = 'Shortcut';
                                break;
                            case 5:
                                $this->typeName = 'Stunts';
                                break;
                            case 6:
    ...
    protected function getStringChunk(array $chunksList)
    {
        ...
        switch ($this->kind) {
            case 0:
                $this->kindName = '(internal)EndMarker';
                break;
            case 1:
                $this->kindName = '(old)Campaign';
                break;
            case 2:
                $this->kindName = '(old)Puzzle';
                break;
            case 3:
                $this->kindName = '(old)Retro';
                break;
            case 4:
                $this->kindName = '(old)TimeAttack';
                break;
            case 5:
                $this->kindName = '(old)Rounds';
                break;
            case 6:
                $this->kindName = 'InProgress';
                break;
            case 7:
                $this->kindName = 'Campaign';
                break;
            case 8:
                $this->kindName = 'Multi';
                break;
            ...
            case 10:
                ...
                break;
            case 11:
                $this->kindName = 'SoloNadeo';
                break;
            case 12:
                $this->kindName = 'MultiNadeo';
                break;
            default:
                $this->kindName = 'UNKNOWN';
        }
...
class GBXPackFetcher extends GBXBaseFetcher
{
    ...
    private function processGBX()
    {
        ...
        if ($this->headerVersn >= 15) {
            $this->headerMaxSz = $this->readInt32();
        } // 0x4000 = small, 0x100000 = big, 0x1000000 = huge
